                        ...
                        <section @click="toggleCartList" class="cart_icon_num">
                            <div class="cart_icon_container" :class="{cart_icon_activity: totalPrice > 0, move_in_cart:receiveInCart}" ref="cartContainer">
                                ...
                                <svg class="cart_icon" >
                                    ...
                                    <use xlink:href="#ele_icon-caigou-copy" style="{color:#fff}"></use>
                                </svg>
                            </div>
                            <div class="cart_num">
                                <div>¥ {{totalPrice}}</div>
                            ...
                            <header>
                                ...
                                <div @click="clearCart">
                                    <svg>
                                        ...
                                        <use xlink:href="#ele_icon-shanchu"></use>
                                    </svg>
                                        ...
                                        <section class="cart_list_control">
                                            <span @click="removeOutCart(item.category_id, item.item_id, item.food_id, item.name, item.price, item.specs)">
                                                <svg>
                                                    ...
                                                    <use xlink:href="#ele_icon-minus-circle"></use>
                                                </svg>
                                            </span>
                                            ...
                                            <svg class="cart_add" @click="addToCart(item.category_id, item.item_id, item.food_id, item.name, item.price, item.specs)">
                                                ...
                                                <use xlink:href="#ele_icon-plus-circle"></use>
                                            </svg>
                                        </section>
                                    </li>
                                </ul>
